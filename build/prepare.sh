...
case ${ENV} in
  production)
    ...
    firebaseAppId=""
    firebaseTenantIdResellers=""
    firebaseTenantIdRetailers=""
    firebaseMeasurementId=""
    ;;

  qa|uat)
    api_hostname="tagd-dash-api.${ENV}.tclstaging.com"
...
FIREBASE_TENANT_ID_RESELLERS=${firebaseTenantIdResellers}
FIREBASE_TENANT_ID_RETAILERS=${firebaseTenantIdRetailers}
...
echo "FIREBASE_TENANT_ID_RESELLERS: ${FIREBASE_TENANT_ID_RESELLERS}"
echo "FIREBASE_TENANT_ID_RETAILERS: ${FIREBASE_TENANT_ID_RETAILERS}"

    ...
    <div class="row q-col-gutter-lg">
      ...
      <div class="col" v-if="isReseller">
        <q-form @submit.prevent="onSubmit">
          <q-input v-model="data.name" label="Name" hint="Enter the name of reseller" placeholder="i.e. eBay" :rules="[
      ...
      <div class="col" v-if="isRetailer">
        <q-form @submit.prevent="onSubmit">
          <q-input v-model="data.name" label="Name" hint="Enter the name of retailer" placeholder="i.e. eBay" :rules="[
            (val) => (val && val.length > 0) || 'This field is required',
          ]" :disable="isFetching" />

...
export const useRetailersFraudReportStore = defineStore(
  'retailersFraudReport',
  {
    persist: true,
    state: () => {
      return {
    ...
    actions: {
      fetchList(page = 1, perPage = 10, filter = {}) {
        return new Promise((resolve, reject) => {
          ...
          api
            .get('retailers/reporting/fraud-report/list', {
              params: {
                ...filter,
                page,
                perPage,
      ...
      fetchGraph(filter = {}) {
        return new Promise((resolve, reject) => {
          ...
          api
            .get('retailers/reporting/fraud-report/graph', {
              params: filter,
            })
            .then((response) => {
